        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxUsers = table.Column<int>(type: "integer", nullable: false),
                    MaxTickets = table.Column<int>(type: "integer", nullable: false),
                    HasTimeTracking = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, null, "Team Manager", "Manager", "MANAGER" },
                    { 3, null, "Support Agent", "Agent", "AGENT" },
                    { 4, null, "Client User", "Client", "CLIENT" }
                });

            migrationBuilder.InsertData(
                table: "Tenants",
                columns: new[] { "Id", "CreatedAt", "CurrentTickets", "CurrentUsers", "CustomDomain", "IsActive", "MaxTickets", "MaxUsers", "Name", "Plan", "Subdomain", "SubscriptionExpiresAt" },
                values: new object[] { 1, new DateTime(2025, 9, 3, 23, 23, 18, 453, DateTimeKind.Utc).AddTicks(4828), 0, 0, null, true, 100, 5, "Default Company", 1, "demo", null });
